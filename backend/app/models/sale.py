...
class Sale(Base, BaseModelMixin):
    ...
    weight: Mapped[float] = mapped_column(Numeric(14, 2), default=0.0)
    weight_rate: Mapped[float] = mapped_column(Numeric(14, 2), default=0.0)
    weight_amount: Mapped[float] = mapped_column(Numeric(18, 2), default=0.0)
    ...
    box_rate: Mapped[float] = mapped_column(Numeric(14, 2), default=0.0)
    box_amount: Mapped[float] = mapped_column(Numeric(18, 2), default=0.0)
    
    total_invoice_amount: Mapped[float] = mapped_column(Numeric(18, 2), default=0.0)
