...
class DayBill(Base, BaseModelMixin):
    ...
    purchase_net_kg: Mapped[float] = mapped_column(Numeric(14, 2), default=0.0)
    ...
    purchase_to_pay: Mapped[float] = mapped_column(Numeric(18, 2), default=0.0)

    sale_net_kg: Mapped[float] = mapped_column(Numeric(14, 2), default=0.0)
    sale_count: Mapped[int] = mapped_column(Integer, default=0)  # total birds
    sale_amount: Mapped[float] = mapped_column(Numeric(18, 2), default=0.0)
    sale_pending: Mapped[float] = mapped_column(Numeric(18, 2), default=0.0)

    expense_total: Mapped[float] = mapped_column(Numeric(18, 2), default=0.0)
